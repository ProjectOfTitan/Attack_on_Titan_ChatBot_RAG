...
st.set_page_config(page_title="AoT Harness Chat", page_icon="⚔️", layout="wide")

st.title("AoT Harness Chat")
st.caption("기존 진격의 거인 RAG 규칙을 유지한 채, 검색 컨텍스트와 하네스 관점을 함께 볼 수 있는 UI입니다.")
...
with st.sidebar:
    ...
    if vectorstore_ready:
        ...
        st.code(
            f"/mnt/e/one_piece/venv/bin/python /mnt/e/one_piece/aot_harness_app/build_vectorstore.py --profile {profile.name}"
        )
